...
public class Img {
    ...
    public static void init(Context context) {
        ...
        OOS = BitmapFactory.decodeResource(context.getResources(), R.drawable.oos);
        BA = BitmapFactory.decodeResource(context.getResources(), R.drawable.ba);
        BB = BitmapFactory.decodeResource(context.getResources(), R.drawable.bb);
        BC = BitmapFactory.decodeResource(context.getResources(), R.drawable.bc);
        BK = BitmapFactory.decodeResource(context.getResources(), R.drawable.bk);
        BN = BitmapFactory.decodeResource(context.getResources(), R.drawable.bn);
        BP = BitmapFactory.decodeResource(context.getResources(), R.drawable.bp);
        BR = BitmapFactory.decodeResource(context.getResources(), R.drawable.br);
        RA = BitmapFactory.decodeResource(context.getResources(), R.drawable.ra);
        RB = BitmapFactory.decodeResource(context.getResources(), R.drawable.rb);
        RC = BitmapFactory.decodeResource(context.getResources(), R.drawable.rc);
        RK = BitmapFactory.decodeResource(context.getResources(), R.drawable.rk);
        RN = BitmapFactory.decodeResource(context.getResources(), R.drawable.rn);
        RP = BitmapFactory.decodeResource(context.getResources(), R.drawable.rp);
